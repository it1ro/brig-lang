...
| Задачи, статус и роадмап    | [доска](https://github.com/users/it1ro/projects/5), `TASKS.md` (карта плана) |
...
- **Регистровая ВМ (§15.1).** Текущая реализация — регистровая (Sprint 7 завершён). Миграция с прежней стековой схемы выполнена; см. `docs/architecture.md` и `docs/02-register-based-virtual-machine.md`.
