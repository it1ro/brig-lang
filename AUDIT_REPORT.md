...
| brig-overview | устарел частично | «65/65» — на деле 62. Иерархия источников истины расходится с AUDIT_PROMPT. |
...
|---|---|---|
| check-examples «65/65» | ✗ | `blocks: checked 62` (в доке 68 fenced-блоков, из них 6 `invalid`) |
